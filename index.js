  ...
  class App extends React.Component {
    ...
    render() {
      return e(
        ...
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', whiteSpace: 'break-spaces'}}, ' | '),
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', cursor: 'pointer'}, onClick: fetch('https://glixzzy.github.io/blooket-hack/global/addTokens.js')}, 'free tokens lol'),
